...
本次在原 WorkBuddy 小红书冷启动 Skill 基础上，补充读取并融合了 yanliudreamer 的 5 篇 X Article:
...
- 发布前约两周缓冲作为可调整起始目标
- 拉新、建立信任、强化标签三件事循环
- 0–1000 / 1000–5000 / 5000–10000 / 10000+ 四阶段节奏假设
- 内容垂直到人设垂直的主号/小号判断
- 问题—经验—观点无灵感兜底模板

核心变化: 复盘不再只是每周看数据，而是把冷启动当作一组实验，并管理内容库存、增长任务和人设延展。详细字段见 `wb-xhs-schedule-review/references/content-rhythm-model.md`。

## 2026-08-01 内容节奏与内容管线补充

本次新增来源的重点不是“每天发几次”，而是把创作、储备和发布做成可观测的内容管线，并按账号阶段调整目标：

- **输入—加工—库存—输出**：先盘点素材、选题/初稿/视觉 Brief、可发布库存和已排输出；发布前尽量保持约两周缓冲，库存低时降低承诺或补库存。
- **拉新—信任—标签循环**：每条内容标注主要任务，分别沉淀受众问题、真实经历/证据或系列/栏目/视觉标签。
- **四阶段起始假设**：0–1000 试错、1000–5000 放大高反馈主题、5000–10000 建立固定栏目和系列、10000+ 形成爆款迭代、合集、评论和内容互相带流量的飞轮。40/30/30、50/30/20、60/20/20 等比例只作为可调整实验起点。
- **内容垂直到人设垂直**：前期让用户和平台形成稳定预期，稳定后按同一成长语境接入多元内容；无法被主线解释的题材建议放小号或矩阵。
- **问题—经验—观点**：没有灵感时使用真实问题、亲历动作和个人判断启动内容，不编造经历、不输出空泛鸡汤。

本次补丁不改变发布前审和视觉技能的所有权，也不承诺固定发帖频率或涨粉结果。
